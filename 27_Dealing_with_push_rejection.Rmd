---
title: "27 Dealing with push rejection"
...
This is covered in the workflow [Pull, but you have local work](https://happygitwithr.com/pull-tricky.html#pull-tricky).  
...
Let’s think about your commit `D`. Maybe it was built up over a couple of days via the [Repeated Amend pattern](https://happygitwithr.com/repeated-amend.html#repeated-amend). Maybe `C` was sitting there on GitHub the whole time or appeared very early in your process.   
...
Finally, your early experiences collaborating with others and yourself in `master` will give you a visceral understanding of why most Git users eventually start to use branches.  
